...
if __name__ == '__main__':
  # Set parameters
  file_prefix = '/workspace/scratch/users/dkundu/RigidMultiblobsWall-master/multi_bodies/examples/sedimentation_sphere/suspension/data/run_sedimentation'
  files_config = ['/workspace/scratch/users/dkundu/RigidMultiblobsWall-master/multi_bodies/examples/sedimentation_sphere/suspension/data/run_sedimentation.colloids_18.config']
  structure = 'cube'
  name_vertex = '/workspace/scratch/users/dkundu/RigidMultiblobsWall-master/multi_bodies/examples/sedimentation_sphere/suspension/cube_N_125_Rh_1.vertex'  
  num_frames = 1000
  # n_save_xyz = 50
  save_blobs = True
  save_dipole = False
