...
if __name__ == '__main__':
  # Set parameters
  file_prefix = '/home/dkundu/Documents/Dipankar_Kundu/RigidMultiblobsWall-master/multi_bodies/examples/sedimentation_sphere/data/run_sedimentation'
  files_config = ['/home/dkundu/Documents/Dipankar_Kundu/RigidMultiblobsWall-master/multi_bodies/examples/sedimentation_sphere/data/run_sedimentation.shell_1.config']
  structure = 'sphere1'
  name_vertex = '/home/dkundu/Documents/Dipankar_Kundu/RigidMultiblobsWall-master/multi_bodies/Structures/shell_N_42_Rg_0_8913_Rh_1.vertex'  
  num_frames = 500
  # n_save_xyz = 50
  save_blobs = True
  save_dipole = False
